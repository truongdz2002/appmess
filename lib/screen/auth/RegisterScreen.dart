        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              MyTextField(controller: controllerNameUser, hintText: 'Họ và tên', obscureText:false,toUpperCase: true),
              const SizedBox(height: 20,),
              ...
              ElevatedButton(onPressed: signUp,style:ElevatedButton.styleFrom(
                ...
                child:const Text('Đăng kí',style: TextStyle(fontSize: 17,color: Colors.white),),),
              const SizedBox(
                height: 30,
              ),
              Row(
